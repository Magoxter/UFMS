//Programa: mediaalgprogi.c
// Programador: Willian Xavier
// Data: 25/11/2012
// O DiÃ¡logo: Este programa calcula a mÃ©dia final de um aluno para
// um curso com o total de trÃªs notas de provas e duas notas de trabalhos.
// A mÃ©dia da disciplina Ã© dada por 0.75 da mÃ©dia das provas somada com
// 0.25 da mÃ©dia dos trabalhos. O alunos pode fazer uma prova optativa
// que substitui a menor nota das provas. Caso a mÃ©dia do aluno seja maior 
// ou igual a 6.0 e a frequÃªncia for igual ou superior a 75% o aluno Ã©
// considerado aprovado (AP). Se o aluno tiver frequÃªncia igual ou superior
// a 75%, mas a nota for menor que 6.0, o aluno Ã© considerado reprovado
// por nota (RN). Se o total de faltas for superior a 25% o aluno Ã©
...
// prÃ©: UmUInt1, UmDouble1, UmFloat2, UmDouble3, UmDouble4, UmDouble5 
...
scanf("%d", &n);
for (i = 0; i < n; i++){
// Passo 1. Leia o nÃºmero e as notas das provas e trabalhos
// Passo 1.1. Leia o nÃºmero do aluno
